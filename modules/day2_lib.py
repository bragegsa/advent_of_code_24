...
def run_day2():
    ...
    print(
        f'The number of safe reports is: 
        {(number_of_safe_reports(data_list))}')
    print(
        f'The number of safe reports with Problem Dampener is: 
        {(number_of_safe_reports(data_list, use_problem_dampener=True))}')
